...
def estudiantesPorSede(): 
    ...
    def obtenerCantidades():
        ...
        try:
            ...
            labelError=Label(ventanaError,text='ERROR: Datos ingresados no válidos ', bg='DarkRed', fg='AliceBlue', font=('arial',20))
            labelError.place(x=50,y=100)
            ventanaError.configure(bg='DarkRed')
...
def estudiatesDeCarreraPorSede():
    ...
    labelTitulo2 = Label(ventana2, text = "Base de datos creada satisfactoriamente" , bg="Teal", fg="Azure", font = ('calibri', 40))
...
def crearMentores():
    ...
    labelTitulo3 = Label(ventana3, text = "Mentores creados satisfactoriamente" , bg="Teal", fg="Azure", font = ('calibri', 40))
...
def asignarMentor():
    ...
    ventana4.geometry('1000x300')
    ventana4.resizable(FALSE,FALSE)
    labelTitulo4 = Label(ventana4, text = "Mentores asignados satisfactoriamente" , bg="Teal", fg="Azure", font = ('calibri', 40))
        ...
        def buscarCarnetPrimerIngreso():
            ...
            for estudiante in dicPrimerIngreso:
                try:
                    ...
                    ventanaError.geometry('600x200')
                    ventanaError.resizable(FALSE,FALSE)
                    labelError=Label(ventanaError,text='ERROR: Dato ingresado no válido ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
                    labelError.place(x=50,y=100)
                    ventanaError.configure(bg='DarkRed')
                    ventanaError.mainloop()
                if estudiante==int(entryCarnet.get()):
                    ...
                    def actualizarPrimerIngreso():
                        ...
                        if not re.match("^\d{8}$",entryTelefono.get()):
                            ventanaError=Tk()
                            ventanaError.title('ERROR')
                            ventanaError.geometry('800x200')
                            ventanaError.resizable(FALSE,FALSE)
                            labelError=Label(ventanaError,text='ERROR: El formato del número de teléfono no es válido ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
                            ...
                            ventanaError.resizable(FALSE,FALSE)
                            labelError=Label(ventanaError,text='ERROR: El formato del correo no es válido ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
                            labelError.place(x=5,y=150)
                            ventanaError.configure(bg='DarkRed')
                            ventanaError.mainloop()
                            botonAceptarAc=Button(ventanaActualizar,text='Aceptar',width=18,height=2,command=actualizarPrimerIngreso)
                            ...
                            ventanaError.geometry('600x300')
                            ventanaError.resizable(FALSE,FALSE)
                            labelError=Label(ventanaError,text='ERROR: Datos ingresados repetidos  ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
            ...
            if bandera==0:
                ...
                labelNo=Label(ventanaNo,text='No se encontró un estudiante con ese carnet ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
                labelNo.place(x=20,y=150)
                ventanaNo.configure(bg='DarkRed')
                ventanaNo.mainloop()
    ...
    def pedirCarnetMentor():
        ...
        def buscarCarnetMentor():
            ...
            if bandera==0:
                ...
                ventanaNo.geometry('600x300')
                ventanaNo.resizable(FALSE,FALSE)
                labelNo=Label(ventanaNo,text='No se encontró un mentor con ese carnet ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
                labelNo.place(x=20,y=150)
                ventanaNo.configure(bg='DarkRed')
                ventanaNo.mainloop()
...
def enviarCorreo():
    ...
    def verificarCorreo():
        ...
        if not re.match("[^@]+@[^@]+\.[^@]+",entryDestinatario.get()):
            ...
            ventanaError.geometry('600x300')
            ventanaError.resizable(FALSE,FALSE)
            labelError=Label(ventanaError,text='ERROR: No se ha creado una base de datos todavía ', bg='DarkRed',fg='AliceBlue', font=('arial',20))
            labelError.place(x=10,y=150)
            ventanaError.configure(bg='DarkRed')
            ventanaError.mainloop()
        else: 
